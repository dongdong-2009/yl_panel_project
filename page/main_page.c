 ...
 * 2017/09/23	     V2.0	  TECH-PRO	      添加return图标
 ***********************************************************************/
static void  CalcMainPageLayout(PT_PageLayout ptPageLayout)
{
	...
	/* return图标 */
	atLayout[3].iTopLeftY  = atLayout[1].iTopLeftY;
	atLayout[3].iBotRightY = atLayout[3].iTopLeftY + iHeight - 1;
	atLayout[3].iTopLeftX  = (iXres + atLayout[1].iBotRightX - iHeight) / 2;
	atLayout[3].iBotRightX = atLayout[3].iTopLeftX + iHeight - 1;
 ...
 * -----------------------------------------------
 * 2013/02/08	     V1.0	  韦东山	      创建
 * 2017/09/23	     V2.0	  TECH-PRO	      添加返回按钮
 ***********************************************************************/
